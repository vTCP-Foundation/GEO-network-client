#ifndef VTCPD_CONFIRMATIONNOTSTRONGLYREQUIREDMESSAGESHANDLER_H
#define VTCPD_CONFIRMATIONNOTSTRONGLYREQUIREDMESSAGESHANDLER_H
...
#endif //VTCPD_CONFIRMATIONNOTSTRONGLYREQUIREDMESSAGESHANDLER_H
