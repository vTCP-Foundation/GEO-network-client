#ifndef VTCPD_CONFIRMATIONNOTSTRONGLYREQUIREDMESSAGESQUEUE_H
#define VTCPD_CONFIRMATIONNOTSTRONGLYREQUIREDMESSAGESQUEUE_H
...
#endif //VTCPD_CONFIRMATIONNOTSTRONGLYREQUIREDMESSAGESQUEUE_H
