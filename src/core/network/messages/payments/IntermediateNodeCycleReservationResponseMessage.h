#ifndef VTCPD_INTERMEDIATENODECYCLERESERVATIONRESPONSEMESSAGE_H
#define VTCPD_INTERMEDIATENODECYCLERESERVATIONRESPONSEMESSAGE_H
...
#endif //VTCPD_INTERMEDIATENODECYCLERESERVATIONRESPONSEMESSAGE_H
