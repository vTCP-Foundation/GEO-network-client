#ifndef VTCPD_INTERMEDIATENODECYCLERESERVATIONREQUESTMESSAGE_H
#define VTCPD_INTERMEDIATENODECYCLERESERVATIONREQUESTMESSAGE_H
...
#endif //VTCPD_INTERMEDIATENODECYCLERESERVATIONREQUESTMESSAGE_H
