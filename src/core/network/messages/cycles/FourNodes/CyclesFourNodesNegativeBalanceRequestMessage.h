#ifndef VTCPD_FOURNODESNEGATIVEBALANCEREQUESTMESSAGE_H
#define VTCPD_FOURNODESNEGATIVEBALANCEREQUESTMESSAGE_H
...
#endif //VTCPD_FOURNODESNEGATIVEBALANCEREQUESTMESSAGE_H
