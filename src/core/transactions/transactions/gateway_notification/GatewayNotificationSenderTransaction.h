#ifndef VTCPD_GATEWAYNOTIFICATIONSENDERTRANSACTION_H
#define VTCPD_GATEWAYNOTIFICATIONSENDERTRANSACTION_H
...
#endif //VTCPD_GATEWAYNOTIFICATIONSENDERTRANSACTION_H
