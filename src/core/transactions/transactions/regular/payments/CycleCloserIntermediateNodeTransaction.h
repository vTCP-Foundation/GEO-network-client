#ifndef VTCPD_CYCLECLOSERINTERMEDIATENODETRANSACTION_H
#define VTCPD_CYCLECLOSERINTERMEDIATENODETRANSACTION_H
...
#endif //VTCPD_CYCLECLOSERINTERMEDIATENODETRANSACTION_H
