#ifndef VTCPD_GETFOURNODESNEIGHBORBALANCESTRANSACTION_H
#define VTCPD_GETFOURNODESNEIGHBORBALANCESTRANSACTION_H
...
#endif //VTCPD_GETFOURNODESNEIGHBORBALANCESTRANSACTION_H
