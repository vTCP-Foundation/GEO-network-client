#ifndef VTCPD_CYCLESFIVESIXNODESRESPOSETRANSACTION_H
#define VTCPD_CYCLESFIVESIXNODESRESPOSETRANSACTION_H
...
#endif //VTCPD_CYCLESFIVESIXNODESRESPOSETRANSACTION_H
