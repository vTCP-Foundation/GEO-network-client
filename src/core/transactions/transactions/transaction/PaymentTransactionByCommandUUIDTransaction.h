#ifndef VTCPD_PAYMENTTRANSACTIONBYCOMMANDUUIDTRANSACTION_H
#define VTCPD_PAYMENTTRANSACTIONBYCOMMANDUUIDTRANSACTION_H
...
#endif //VTCPD_PAYMENTTRANSACTIONBYCOMMANDUUIDTRANSACTION_H
