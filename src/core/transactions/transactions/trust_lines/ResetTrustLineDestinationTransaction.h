#ifndef VTCPD_RESETTRUSTLINEDESTINATIONTRANSACTION_H
#define VTCPD_RESETTRUSTLINEDESTINATIONTRANSACTION_H
...
#endif //VTCPD_RESETTRUSTLINEDESTINATIONTRANSACTION_H
