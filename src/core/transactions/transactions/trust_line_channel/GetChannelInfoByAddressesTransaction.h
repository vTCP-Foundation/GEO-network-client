#ifndef VTCPD_GETCHANNELINFOBYADDRESSESTRANSACTION_H
#define VTCPD_GETCHANNELINFOBYADDRESSESTRANSACTION_H
...
#endif //VTCPD_GETCHANNELINFOBYADDRESSESTRANSACTION_H
