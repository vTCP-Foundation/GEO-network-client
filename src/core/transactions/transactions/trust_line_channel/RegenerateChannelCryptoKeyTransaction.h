#ifndef VTCPD_REGENERATECHANNELCRYPTOKEYTRANSACTION_H
#define VTCPD_REGENERATECHANNELCRYPTOKEYTRANSACTION_H
...
#endif //VTCPD_REGENERATECHANNELCRYPTOKEYTRANSACTION_H
