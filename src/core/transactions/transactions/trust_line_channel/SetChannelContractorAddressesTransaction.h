#ifndef VTCPD_SETCHANNELCONTRACTORADDRESSESTRANSACTION_H
#define VTCPD_SETCHANNELCONTRACTORADDRESSESTRANSACTION_H
...
#endif //VTCPD_SETCHANNELCONTRACTORADDRESSESTRANSACTION_H
