#ifndef VTCPD_SETCHANNELCONTRACTORCRYPTOKEYTRANSACTION_H
#define VTCPD_SETCHANNELCONTRACTORCRYPTOKEYTRANSACTION_H
...
#endif //VTCPD_SETCHANNELCONTRACTORCRYPTOKEYTRANSACTION_H
